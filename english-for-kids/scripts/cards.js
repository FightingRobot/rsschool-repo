const cards = [
    ['Actions (Set A)', 'Actions (Set B)', 'Actions (Set C)', 'Colors', 'Animals (Set A)', 'Animals (Set B)', 'Clothes', 'Emotions'],
    [
        {
            word: 'cry',
            translation: 'плакать',
    ...
    [
        {
            ...
            audioSrc: 'assets/audio/call.mp3'
        },
        {
            word: 'flex',
            translation: 'отдыхать от души',
            image: 'assets/img/flex.jpg',
            audioSrc: 'assets/audio/flex.mp3'
        },
        {
            word: 'grin',
            translation: 'улыбаться',
            image: 'assets/img/grin.jpg',
            audioSrc: 'assets/audio/grin.mp3'
        },
        {
            word: 'train',
        ...
        {
            word: 'surf internet',
            translation: 'сёрфить интернет',
            image: 'assets/img/surf.jpg',
            audioSrc: 'assets/audio/surf.mp3'
        },
        {
            word: 'walk',
            translation: 'идти',
            image: 'assets/img/walk.jpg',
            audioSrc: 'assets/audio/walk.mp3'
        },
        {
            word: 'sit',
            translation: 'сидеть',
            image: 'assets/img/sit.jpg',
            audioSrc: 'assets/audio/sit.mp3'
        },
        {
            word: 'sleep',
            translation: 'спать',
    ...
    [
        ...
        },
        {
            word: 'gray',
            translation: 'серый',
            image: 'assets/img/gray.jpg',
            audioSrc: 'assets/audio/gray.mp3'
        },
        {
            word: 'purple',
